...
export class ShopService extends ProductService implements AfterContentInit, AfterViewInit, OnInit {
  ...
  public setPosts() {
    var postsByCategory = this.getCategory() != undefined ? this.getPostsByCategory(this.getCategory()) : '',
      postsByTag = this.getTag() != undefined ? this.getPostsByTag(this.getTag()) : '',
      postsBySearch = this.getSearch() != undefined ? this.getPostsBySearch(this.getSearch()) : '',
      postsByPrice = this.getPrice() != undefined ? this.getPostsByPrice(this.getPrice()[0], this.getPrice()[1]) : '';
